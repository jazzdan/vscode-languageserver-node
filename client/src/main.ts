 ...
 * In node terms the VS Code process calls `createServer`, then starts the server
 ...
 * be sent back and forth. If the language server is implemented in a different
 * programming language the server simply needs to create a connection to the
